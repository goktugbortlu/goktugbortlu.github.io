...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 30px; align-items: start;">
  ...
  <div>
    ...
    <p style="text-align: center; font-size: 0.85em; color: #666; margin-top: 10px; line-height: 1.4;">And this is Gece [gedʒe] blending into the dark. Her name means "night" in Turkish, and she carries that name ​very well, ​I guess.</p>
  </div>
